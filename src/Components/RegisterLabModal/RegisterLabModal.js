        ...
        <Box className={style.wrapper}>
          ...
          <div className={style.row1}>
            <input
              ...
              onChange={(e) =>
                setDetails({ ...details, lab_name: e.target.value })
              }
            />
            <input
              type="text"
              ...
              onChange={(e) =>
                setDetails({ ...details, lab_address: e.target.value })
              }
            />
          </div>
          <div className={style.row2}>
            <input
              ...
              onChange={(e) =>
                setDetails({ ...details, lab_admin_name: e.target.value })
              }
            />
            <input
              type="number"
              defaultValue={"50"}
              onChange={(e) =>
                setDetails({ ...details, lab_student_capacity: e.target.value })
              }
            />
          </div>
          <div className={style.row2}>
            <input
              ...
              onChange={(e) =>
                setDetails({ ...details, lab_description: e.target.value })
              }
            />
          </div>
